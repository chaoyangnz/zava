...
pub fn call(class: string, method: string, args: []Value) Value {
    const qualifier = concat(concat(class, "."), method);
...
const natives = .{
    ...
    "java/lang/System.initProperties(Ljava/util/Properties;)Ljava/util/Propertie.;",
    java_lang_System.initProperties,
    "java/lang/System.mapLibraryName(Ljava/lang/String;)Ljava/lang/Strin.;",
    ...
    "java/lang/Object.getClass()Ljava/lang/Clas.;",
    java_lang_Object.getClass,
    "java/lang/Object.clone()Ljava/lang/Objec.;",
    ...
    "java/lang/Class.getPrimitiveClass(Ljava/lang/String;)Ljava/lang/Clas.;",
    ...
    "java/lang/Class.getDeclaredFields0(Z)[Ljava/lang/reflect/Fiel.;",
    java_lang_Class.getDeclaredFields0,
    "java/lang/Class.isPrimitive(.Z",
    java_lang_Class.isPrimitive,
    "java/lang/Class.isAssignableFrom(Ljava/lang/Class;.Z",
    java_lang_Class.isAssignableFrom,
    "java/lang/Class.getName0()Ljava/lang/Strin.;",
    java_lang_Class.getName0,
    //"java/lang/Class.forName0(Ljava/lang/String;ZLjava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Clas.;", java_lang_Class.forName0,
    "java/lang/Class.isInterface(.Z",
    java_lang_Class.isInterface,
    "java/lang/Class.getDeclaredConstructors0(Z)[Ljava/lang/reflect/Constructo.;",
    java_lang_Class.getDeclaredConstructors0,
    "java/lang/Class.getModifiers(.I",
    java_lang_Class.getModifiers,
    "java/lang/Class.getSuperclass()Ljava/lang/Clas.;",
    java_lang_Class.getSuperclass,
    "java/lang/Class.isArray(.Z",
    java_lang_Class.isArray,
    "java/lang/Class.getComponentType()Ljava/lang/Clas.;",
    java_lang_Class.getComponentType,
    "java/lang/Class.getEnclosingMethod0()[Ljava/lang/Objec.;",
    java_lang_Class.getEnclosingMethod0,
    "java/lang/Class.getDeclaringClass0()Ljava/lang/Clas.;",
    java_lang_Class.getDeclaringClass0,
    "java/lang/Class.forName0(Ljava/lang/String;ZLjava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Clas.;",
    java_lang_Class.forName0,

    "java/lang/ClassLoader.registerNatives(.V",
    java_lang_ClassLoader.registerNatives,
    "java/lang/ClassLoader.findBuiltinLib(Ljava/lang/String;)Ljava/lang/Strin.;",
    ...
    "java/lang/ClassLoader.findLoadedClass0(Ljava/lang/String;)Ljava/lang/Clas.;",
    java_lang_ClassLoader.findLoadedClass0,
    "java/lang/ClassLoader.defineClass1(Ljava/lang/String;[BIILjava/security/ProtectionDomain;Ljava/lang/String;)Ljava/lang/Clas.;",
    java_lang_ClassLoader.defineClass1,
    "java/lang/ClassLoader.findBootstrapClass(Ljava/lang/String;)Ljava/lang/Clas.;",
    java_lang_ClassLoader.findBootstrapClass,

    "java/lang/Package.getSystemPackage0(Ljava/lang/String;)Ljava/lang/Strin.;",
    java_lang_Package.getSystemPackage0,

    "java/lang/String.intern()Ljava/lang/Strin.;",
    ...
    "java/lang/Thread.currentThread()Ljava/lang/Threa.;",
    ...
    "java/lang/Throwable.fillInStackTrace(I)Ljava/lang/Throwabl.;",
    java_lang_Throwable.fillInStackTrace,
    "java/lang/Throwable.getStackTraceElement(I)Ljava/lang/StackTraceElemen.;",
    ...
    "java/security/AccessController.doPrivileged(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Objec.;",
    java_security_AccessController.doPrivileged,
    "java/security/AccessController.doPrivileged(Ljava/security/PrivilegedAction;)Ljava/lang/Objec.;",
    java_security_AccessController.doPrivileged,
    "java/security/AccessController.getStackAccessControlContext()Ljava/security/AccessControlContex.;",
    java_security_AccessController.getStackAccessControlContext,
    "java/security/AccessController.doPrivileged(Ljava/security/PrivilegedExceptionAction;Ljava/security/AccessControlContext;)Ljava/lang/Objec.;",
    java_security_AccessController.doPrivilegedContext,

    "java/lang/reflect/Array.newArray(Ljava/lang/Class;I)Ljava/lang/Objec.;",
    ...
    "sun/misc/Unsafe.getObjectVolatile(Ljava/lang/Object;J)Ljava/lang/Objec.;",
    ...
    "sun/reflect/Reflection.getCallerClass()Ljava/lang/Clas.;",
    ...
    "sun/reflect/NativeConstructorAccessorImpl.newInstance0(Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)Ljava/lang/Objec.;",
    sun_reflect_NativeConstructorAccessorImpl.newInstance0,

    "sun/misc/URLClassPath.getLookupCacheURLs(Ljava/lang/ClassLoader;)[Ljava/net/UR.;",
    ...
    "java/io/UnixFileSystem.canonicalize0(Ljava/lang/String;)Ljava/lang/Strin.;",
    ...
    "java/util/TimeZone.getSystemTimeZoneID(Ljava/lang/String;)Ljava/lang/Strin.;",
    java_util_TimeZone.getSystemTimeZoneID,
};

test "xx" {
    std.log.warn("{}", .{@TypeOf(natives)});
}
